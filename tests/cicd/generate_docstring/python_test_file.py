def a_plus_b(a, b):
    """Function that adds two numbers a and b together.
...
def compare(key_map, item1, item2):
    ...
    Returns:
        int: -1 if key_map(item1) is less than key_map(item2), 1 if key_map(item1) is greater than key_map(item2), and 0 if they are equal.
    """
